...
var express       = require("express"),
    ...
    Showfinder      = require("./models/showfinder"),
...
app.use(require("express-session")({
    secret: "Alas! My doom has come upon me.",
    resave: false,
...
app.use("/", indexRoutes);
app.use("/showfinders", locationRoutes);
app.use("/showfinders/:id/comments", commentRoutes);
